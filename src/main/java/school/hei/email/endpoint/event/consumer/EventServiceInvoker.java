package school.hei.email.endpoint.event.consumer;
...
import school.hei.email.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("school.hei.email.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "school.hei.email.service.event."
