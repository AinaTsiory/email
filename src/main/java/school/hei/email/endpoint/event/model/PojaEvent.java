package school.hei.email.endpoint.event.model;

import static java.lang.Math.random;
import static school.hei.email.endpoint.event.EventStack.EVENT_STACK_1;
...
import school.hei.email.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    if (getEventStack().equals(EVENT_STACK_1)) return "school.hei.email.event1";
    return "school.hei.email.event2";
  }
}
