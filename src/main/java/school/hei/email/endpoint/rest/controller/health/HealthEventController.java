package school.hei.email.endpoint.rest.controller.health;

import static java.util.UUID.randomUUID;
import static school.hei.email.endpoint.rest.controller.health.PingController.KO;
import static school.hei.email.endpoint.rest.controller.health.PingController.OK;
...
import school.hei.email.endpoint.event.model.DurablyFallibleUuidCreated1;
import school.hei.email.endpoint.event.model.DurablyFallibleUuidCreated2;
import school.hei.email.endpoint.event.model.UuidCreated;
import school.hei.email.repository.DummyUuidRepository;
import school.hei.email.repository.model.DummyUuid;
