package school.hei.email.handler;

import static java.lang.System.getenv;
import static java.lang.Thread.currentThread;
import static school.hei.email.concurrency.ThreadRenamer.renameWorkerThread;
...
import school.hei.email.PojaApplication;
import school.hei.email.PojaGenerated;
import school.hei.email.endpoint.EndpointConf;
import school.hei.email.endpoint.event.EventConf;
import school.hei.email.endpoint.event.consumer.EventConsumer;
import school.hei.email.endpoint.event.consumer.model.ConsumableEvent;
import school.hei.email.endpoint.event.consumer.model.ConsumableEventTyper;
